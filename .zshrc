...
# define a launch function to launch and disown apps
launch () {
        ("$@" &) > /dev/null 2>&1
}
...
# -------- add the prime run to launch that you think needs gpu --------
alias browser='launch prime-run brave'
alias code-editor="launch prime-run code"
alias monitors="launch nwg-displays"
alias files="nnn"
